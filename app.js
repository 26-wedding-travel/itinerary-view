const itinerary = [
  ...
  },
  {
    ...
    title: "몬세라트 & 시체스 투어",
    city: "바르셀로나",
    route: "숙소 → 몬세라트 → 시체스 → 숙소/시내 → Bar Cañete",
    lodging: "Duquesa de Cardona 4* Sup",
    stops: [
      { name: "Duquesa de Cardona", note: "08:30 호텔 픽업", coords: [41.3802, 2.1815] },
      { name: "Aeri de Montserrat", note: "케이블카 하부역", coords: [41.5912, 1.8534] },
      { name: "Montserrat Monastery", note: "수도원/자유 관람", coords: [41.5936, 1.8375] },
      { name: "Sitges", note: "해변 점심 및 골목 산책", coords: [41.2343, 1.8064] },
      { name: "Duquesa de Cardona", note: "18:00 전후 하차/휴식", coords: [41.3802, 2.1815] },
      { name: "Bar Cañete", note: "워크인 도전", coords: [41.379, 2.1736] },
    ],
    timeline: [
      ["08:30", "호텔 픽업", "Duquesa de Cardona", "MyRealTrip 몬세라트+시체스, 예약번호 확인 필요"],
      ["09:15", "케이블카 탑승장 도착", "Aeri de Montserrat", "상품 상세 기준"],
      ["09:30", "케이블카 탑승", "Aeri → Monastery", "왕복 약 €13.50/인 별도"],
      ["09:45", "몬세라트 수도원 도착", "Montserrat Monastery", "코스 설명 후 자유 관람"],
      ["10:15", "몬세라트 자유 관람", "Basilica / Monastery", "성모상은 공식 슬롯과 일정 조정 가능 시만 예약"],
      ["13:30", "케이블카 하산", "Montserrat → Aeri", "14:00 시체스 출발 준비"],
      ["14:00", "시체스 이동", "Montserrat → Sitges", "투어 차량"],
      ["14:45", "시체스 해변 도착 & 점심", "Sitges", "점심 후 해변/골목 산책"],
      ["17:00", "시체스 출발", "Sitges → Barcelona", "투어 차량"],
      ["18:00", "바르셀로나 하차 & 휴식", "호텔/시내", "하차 지점 확인 필요"],
    ...
    transport: [
      "호텔 픽업형 단독 차량 투어: 08:30 Duquesa de Cardona 픽업 확인",
      "몬세라트 케이블카 왕복: 약 €13.50/인 별도",
      "공식 입장권: 성가대 제외 시 Ticket to the Throne of Our Lady €12/인",
      "2026-07-01 성모상 슬롯은 기본 일정과 맞지 않아 투어사 일정 조정 확인 필요",
      "Bar Cañete ↔ 숙소: 도보 가능",
    ],
    foodCandidates: [
      {
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "BCN 공항 T1", note: "LX1953 09:40 출발, 탑승 09:10", coords: [41.3031, 2.0734] },
    ...
    timeline: [
      ["07:00", "체크아웃 & 공항 이동", "BCN 공항 T1", "택시 권장, 수하물 카운터 601-607은 08:55까지"],
      ["09:10", "탑승 시작", "BCN 공항 T1", "Swiss LX1953, Group 3, 좌석 26A/26B"],
      ["09:25", "게이트 마감", "BCN 공항 T1", "게이트는 당일 전광판/SWISS 앱 확인"],
    ...
    transport: [
      "Swiss LX1953 09:40 → 11:30, 체크인 완료, 좌석 26A/26B",
      "BCN T1 수하물 카운터 601-607, 08:55까지",
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "Trattoria San Lorenzo", note: "티본스테이크 저녁", coords: [43.7746, 11.2548] },
    ...
    timeline: [
      ...
      ["저녁", "티본스테이크 디너", "Trattoria San Lorenzo", "방문 전 예약/영업시간 확인"],
      ["식후", "베키오 다리 야경", "Ponte Vecchio", ""],
    ],
    transport: [
    ...
    foodCandidates: [
      ...
      },
      {
        ...
        summary: "산 로렌초 광장 도보권 티본스테이크 목표. 공식 메뉴 기준 T-bone €65/kg부터.",
      },
      {
        slot: "저녁 특별식",
  ...
  },
  {
    day: 9,
    date: "7월 7일 (화)",
    title: "오전 산책, 우피치, 스냅 촬영",
    city: "피렌체",
    route: "숙소 → 두오모 → 시뇨리아 광장 → 베키오 다리 → 우피치 → 젤라또 → 숙소 → 저녁 → 산 미니아토 알 몬테",
    lodging: "Martelli 6 Suite & Apartments",
    stops: [
      { name: "Martelli 6", note: "출발", coords: [43.7738, 11.2557] },
      { name: "Duomo di Firenze", note: "오전 외관 산책", coords: [43.7731, 11.256] },
      { name: "Piazza della Signoria", note: "팔라초 베키오 외관", coords: [43.7696, 11.2558] },
      { name: "Ponte Vecchio", note: "아르노 강변 사진", coords: [43.768, 11.2531] },
      { name: "Mercato Centrale", note: "가벼운 점심", coords: [43.7764, 11.2533] },
      { name: "Uffizi Gallery", note: "14:15 입장권 구매 완료", coords: [43.7687, 11.2556] },
      { name: "Perche No!", note: "우피치 후 젤라또", coords: [43.7704, 11.2566] },
      { name: "Martelli 6", note: "샤워/에어컨/스냅 준비", coords: [43.7738, 11.2557] },
      { name: "Trattoria 4 Leoni", note: "스냅 전 저녁 후보", coords: [43.7677, 11.2495] },
      { name: "Abbazia di San Miniato al Monte", note: "20:20 스냅 미팅", coords: [43.7592, 11.2651] },
      { name: "Piazza Santa Croce", note: "촬영 후 산책", coords: [43.7686, 11.2623] },
    ],
    timeline: [
      ["09:30", "오전 산책 출발", "Martelli 6", "더워지기 전 야외만 가볍게"],
      ["09:40", "두오모 외관 산책", "Duomo di Firenze", "광장/사진 중심"],
      ["10:20", "시뇨리아 광장", "Piazza della Signoria", "팔라초 베키오 외관"],
      ["10:55", "베키오 다리 & 아르노", "Ponte Vecchio", "강변 사진 후 점심으로 전환"],
      ["12:00", "가벼운 점심", "Mercato Centrale / 산 로렌초", "저녁과 스냅을 위해 과식하지 않기"],
      ["13:15", "숙소/카페 짧은 리셋", "Martelli 6 주변", "물 보충, 티켓 확인"],
      ["14:15", "우피치 미술관 입장", "Uffizi", "입장권 구매 완료"],
      ["14:15~16:20", "우피치 관람", "Uffizi", "한낮 더위 피하면서 핵심 작품 위주"],
      ["16:30", "젤라또 픽업", "Perche No! / 두오모 주변", "숙소 가는 길"],
      ["16:50~18:20", "숙소 휴식 & 스냅 준비", "Martelli 6", "샤워, 에어컨, 의상/메이크업"],
      ["18:45~19:35", "스냅 전 저녁", "올트라르노/산 니콜로", "맛있게 먹되 너무 무겁지 않게"],
      ["20:00", "스냅 미팅 포인트 도착", "Abbazia di San Miniato al Monte", "성당 앞 계단, 20분 전 도착 목표"],
      ["20:20~21:20", "피렌체 PICCOLO 스냅 촬영", "산 미니아토 알 몬테 / 미켈코스", "잔금 현금, 큰 짐 금지"],
      ["21:30", "촬영 후 야경 산책", "산타크로체/두오모", "컨디션 좋으면 짧게"],
    ],
    transport: [
      "오전 야외 산책은 도보 중심으로 짧게",
      "14:15 우피치 입장으로 한낮 더위를 실내에서 피하기",
      "우피치 후 숙소 복귀해 샤워/에어컨/의상 정리",
      "저녁 장소 → 산 미니아토 알 몬테는 오르막/야간이라 택시 권장",
      "택시는 appTaxi / Taxi Move / 호텔 콜택시, 버스는 비추천",
      "촬영에는 휴대폰, 현금, 카드, 촬영 소품만 챙기기",
    ],
    foodCandidates: [
      {
        slot: "점심",
        name: "Da Nerbone / 중앙시장",
        summary: "점심은 가볍게. 저녁과 스냅을 위해 람프레도토/파스타 정도로 조절.",
      },
      {
        slot: "점심 대안",
        name: "Il Tartufo",
      ...
      },
      {
        slot: "우피치 후",
        name: "Perche No!",
        summary: "우피치에서 숙소로 돌아가는 길의 젤라또 후보. 하나 사서 숙소에서 쉬는 흐름.",
      },
      {
        slot: "스냅 전 저녁",
        name: "Trattoria 4 Leoni",
        summary: "올트라르노 전통 트라토리아 후보. 예약 가능하면 우선, 촬영 전엔 너무 무겁지 않게.",
      },
      {
        slot: "스냅 전 대안",
        name: "Gurdulu",
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "Firenze SMN", note: "09:43 출발", coords: [43.7768, 11.248] },
      { name: "Roma Termini", note: "13:30 도착", coords: [41.9009, 12.502] },
      { name: "Navona Palace", note: "체크인/짐 보관", coords: [41.8993, 12.4709] },
      { name: "Fontana di Trevi", note: "늦은 오후", coords: [41.9009, 12.4833] },
      { name: "Piazza di Spagna", note: "늦은 오후", coords: [41.9059, 12.4823] },
      { name: "Trastevere", note: "저녁", coords: [41.8897, 12.4702] },
    ],
    timeline: [
      ["08:50", "체크아웃 & 역 이동", "Martelli 6", "SMN까지 도보"],
      ["09:43", "피렌체 → 로마", "Italo 8129 Smart/Flex", "발권 완료"],
      ["13:30", "로마 도착", "Roma Termini", "숙소까지 이동"],
      ["14:15", "짐 맡기기/늦은 점심", "Navona Palace 주변", ""],
      ["늦은 오후", "트레비 분수 & 스페인 계단", "Centro Storico", "숙소 도보권"],
      ["저녁", "트라스테베레", "Trastevere", "로마 현지 감성 디너"],
    ],
    transport: [
      "Firenze SMN → Roma Termini: Italo 8129 09:43 → 13:30 발권 완료",
  ...
  },
  {
    ...
    title: "바티칸과 테베레강",
    city: "로마/바티칸",
    route: "나보나 → Antico Caffe Candia → 바티칸 박물관 → 성베드로 → 산탄젤로",
    lodging: "Navona Palace Luxury Inn",
    stops: [
      { name: "Navona Palace", note: "출발", coords: [41.8993, 12.4709] },
      { name: "Antico Caffe Candia", note: "09:10~09:30 투어 미팅, 주소 기준 추정 좌표", coords: [41.9076, 12.4488] },
      { name: "Vatican Museums", note: "09:30 패스트트랙 입장", coords: [41.9065, 12.4536] },
      { name: "Sistine Chapel", note: "박물관 내", coords: [41.9029, 12.4545] },
      { name: "St. Peter's Basilica", note: "14:10~14:30 전후 종료", coords: [41.9022, 12.4539] },
      { name: "Bonci Pizzarium", note: "늦은 점심 후보", coords: [41.9095, 12.4468] },
      { name: "Castel Sant'Angelo", note: "테베레강 산책", coords: [41.9031, 12.4663] },
      { name: "Campo de' Fiori", note: "저녁", coords: [41.8957, 12.4722] },
    ],
    timeline: [
      ["08:40", "숙소 출발", "Navona Palace", "Cipro 역/Antico Caffe Candia 방향, 택시 우선"],
      ["09:10~09:30", "바티칸 투어 미팅", "Antico Caffe Candia 앞 광장", "예약번호 EXP-20260626-20007873"],
      ["09:30", "바티칸 박물관 패스트트랙 입장", "Musei Vaticani", "현장 티켓비 €110 현금"],
      ["오전~오후", "바티칸 박물관 & 시스티나 성당", "Musei Vaticani", "한국어 가이드"],
      ["14:10~14:30", "성베드로 대성당 내부 투어 종료", "Basilica di San Pietro", "성당 행사/통제 시 변경 가능"],
      ["14:40", "늦은 점심", "Bonci Pizzarium 또는 바티칸 주변", "투어 후 가볍게"],
      ["오후", "산탄젤로 성", "Castel Sant'Angelo", "테베레강 산책"],
      ["저녁", "캄포 데 피오리", "Campo de' Fiori", "마지막 로마 밤"],
    ],
    transport: [
      "숙소 → Antico Caffe Candia: 택시 우선, 08:40~08:50 출발 목표",
      "미팅 시간은 보통 09:10~09:30, 전날/전전날 카카오톡 안내 확인",
      "현장 현금: 바티칸 티켓비 €110 준비",
    ],
    foodCandidates: [
      {
        slot: "점심",
